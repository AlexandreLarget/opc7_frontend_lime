...
def main():
    ...
    if predict_btn:
        response1 = requests.post('https://opc7-backend-lime.herokuapp.com/predict', data=json.dumps(id_data, allow_nan=True))
        ...
        # Explication
        response_2 = requests.get("https://opc7-backend-lime.herokuapp.com/gal_exp/" + str(input_id))
